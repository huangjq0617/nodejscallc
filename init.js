...
async function main() {
    ...
    const js_c_code = generate_js(class_name, init_params, functions, desc, version, 'c');
    const js_python_code = generate_js(class_name, init_params, functions, desc, version, 'python');
    const {
        c_imp_code,
        c_init_code,
        c_header_code,
        c_pipe_code,
     } = generate_c(class_name, init_params, functions, desc, version);
    const python_code = generate_python(class_name, init_params, functions, desc, version);
